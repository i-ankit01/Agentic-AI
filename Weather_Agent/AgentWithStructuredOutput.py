...
# now using pydantic you can define your own structured output format
class MyOutputFormat(BaseModel): 
    step: str = Field(..., description="The id of the current step , example PLAN, TOOL, OUTPUT etc")
    content : Optional[str] = Field(None, description="The optional string content for the step")
    tool : Optional[str] = Field(None, description="the name of the tool called")
    input : Optional[str] = Field(None, description="The input required for the tool calling")
